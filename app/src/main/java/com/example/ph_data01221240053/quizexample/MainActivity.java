...
package com.example.ph_data01221240053.quizexample;
...
int position=0;
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("position", mData.getPosition());
        outState.putInt("state", mCurrentState);
        outState.putString("word", mWordTextView.getText().toString());
        outState.putString("def", mDefinitionTextView.getText().toString());
        outState.putString("button", mButton.getText().toString());
        outState.putInt("mdefcol", mDefCol);
        outState.putInt(" mWordCol", mWordCol);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mCurrentState = savedInstanceState.getInt("state", mCurrentState);

            mWordTextView.setText(savedInstanceState.getString("word", mWordTextView.getText().toString()));
                mDefinitionTextView.setText(savedInstanceState.getString("def", mDefinitionTextView.getText().toString()));
            mButton.setText(savedInstanceState.getString("button", mButton.getText().toString()));

            mDefCol = savedInstanceState.getInt("mdefcol", mDefCol);
            mWordCol = savedInstanceState.getInt("mWordCol", mWordCol);
